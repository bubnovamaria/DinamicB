<<<<<<< Updated upstream
﻿// DinamicB.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main() ///комм для проверки изменений
{
	HINSTANCE dll = LoadLibrary(L"BUBNOVADLL.dll"); ///получаем указатель на DLL
	{
		...
		Name = (name*)GetProcAddress(dll, "Name"); ////коммм
